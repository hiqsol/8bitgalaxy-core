...
class Deck {
  ...
  get ships() {
    return this.getOfType("ship", "_ships");
  }

  get bases() {
    return this.getOfType("base", "_bases");
  }

  get heroes() {
    return this.getOfType("hero", "_heroes");
  }

  get colonies() {
    return this.getOfType("colony", "_colonies");
  }
  ...
  get size() {
    return Object.keys(this.lower).length;
  }
