...
class aCard {
  ...
  get isHero() {
    return this.isType(Type.Hero);
  }

  get isColony() {
    return this.isType(Type.Colony);
  }

  get isShip() {
    return this.isType(Type.Ship);
  }

  get isBase() {
    return this.isType(Type.Base);
  }
  ...
  buildUniq() {
    ...
    return this.Name > this.Alternative.Name ? this.Name + "/" + this.Alternative.Name : this.Alternative.Name + "/" + this.Name;
  }
